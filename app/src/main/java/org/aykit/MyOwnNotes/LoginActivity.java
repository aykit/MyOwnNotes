...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final int PICK_ACCOUNT_REQUEST = 12412;
    ...
    private void showAccounts() {
        ...
        if (accounts.length == 0) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                startActivityForResult(AccountManager.newChooseAccountIntent(null, null, new String[]{getString(R.string.account_type)}, null,
                        null, null, null), PICK_ACCOUNT_REQUEST);
            } else {
                startActivityForResult(AccountManager.newChooseAccountIntent(null, null, new String[]{getString(R.string.account_type)}, true, null,
                        null, null, null), PICK_ACCOUNT_REQUEST);
            }
        }
    }
